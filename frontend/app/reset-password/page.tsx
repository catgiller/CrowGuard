      ...
      <div className="login-card">
        ...
        {isSuccess ? (
          <div className="success-box">
            <p style={{ margin: 0, fontWeight: 600, marginBottom: "0.5rem" }}>Şifreniz güncellendi!</p>
            <p style={{ margin: 0, fontSize: "0.8125rem", opacity: 0.9 }}>Giriş sayfasına yönlendiriliyorsunuz...</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit}>
            <div className="field">
              ...
              <div className="field-row">
                ...
                <input type="password" name="password" placeholder="••••••••" required minLength={6} value={password} onChange={(e) => setPassword(e.target.value)} />
              </div>
            </div>
            ...
            <div className="field">
              ...
              <div className="field-row">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0110 0v4" /></svg>
                <input type="password" name="confirmPassword" placeholder="••••••••" required minLength={6} value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
              </div>
            </div>
